...
<h3 align="center">Please kindly download the AjPlusHealthCare Job Application Form Below,
  <br> And fill it with a valid information and submit to the email below;<br> agency@ajplushealthcare.co.uk</h3>
  <br>
<div class="row">
  <div class="col-lg-12 text-center">
   <a href="/download2"> <button type="submit" name="button">{{__('Download Now')}}</button></a>
  </div>
</div>
<br>
