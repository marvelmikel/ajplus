...
//Aj cleaning job application form
Route::get('/download2', function(){
  $file = public_path()."/files/Application-Form.docx";

  $headers = array(
      'Content-type: application/docx',
  );

  return Response::download($file, "AJPlusHealthcare-WORKER-APPLICATION-FORM.docx", $headers);
});
